...
class TestPreprocessing(unittest.TestCase):
    ...
    def test_convert_entry_exit_actions(self):
        statechart = StatechartParser().parse(path='testdata/test_preprocessing/test_convert_entry_exit_actions.ysc')
        preprocessor.process(statechart)
        statechart_expected = StatechartParser().parse(
            path='testdata/test_preprocessing/test_convert_entry_exit_actions_expected.ysc'
        )
